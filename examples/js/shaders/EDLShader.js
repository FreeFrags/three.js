 ...
 *
 * Ported from potree
 * https://github.com/potree/potree/tree/master/src/materials/shaders
 *
 * based on code from Christian Boucheny in cloud compare
...
THREE.EDLShader = {
	...
	uniforms: {
		...
		"near": { type: "f", value: null },
		"far": { type: "f", value: null },
		"neighbours": { type: "2fv", value: null }, //NEIGHBOUR_COUNT 8
		"lightDir": { type: "v3", value: null },
		"expScale": { type: "f", value: null },
